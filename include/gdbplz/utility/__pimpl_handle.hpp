...
namespace wiertlo
{
	...
	public:
		...
		static auto get_handle(const pimpl_handle_type& pimpl) ->
			decltype((*reinterpret_cast<const HandleType*>(pimpl.buffer)))
		{
			return *reinterpret_cast<const HandleType*>(pimpl.buffer);
		}
		
		static auto get_handle(pimpl_handle_type& pimpl) ->
			decltype((*reinterpret_cast<HandleType*>(pimpl.buffer)))
		{
